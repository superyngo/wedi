#!/usr/bin/env bash
# wedi Remote Installation Script for Linux/macOS
# Usage: curl -fsSL https://raw.githubusercontent.com/superyngo/wedi/main/install.sh | bash
...
# Configuration
APP_NAME="wedi"
REPO="superyngo/wedi"  # TODO: Replace with actual GitHub superyngo/repo
...
download_release() {
    ...
    # - Linux: wedi-linux-x86_64.tar.gz, wedi-linux-aarch64.tar.gz, etc.
    # - macOS: wedi-macos-x86_64.tar.gz, wedi-macos-aarch64.tar.gz
...
install_wedi() {
    print_info "=== wedi Installation Script ==="
    echo ""
    ...
    echo ""
    print_info "Usage:"
    print_info "  $APP_NAME <filename>       - Edit a file"
    print_info "  $APP_NAME --help           - Show help"
    print_info "  $APP_NAME --version        - Show version"
    echo ""
...
uninstall_wedi() {
    print_info "=== wedi Uninstallation Script ==="
    echo ""
