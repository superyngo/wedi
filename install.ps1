#!/usr/bin/env pwsh
# wedi Remote Installation Script for Windows
# Usage: irm https://raw.githubusercontent.com/superyngo/wedi/main/install.ps1 | iex
...
function Install-Wedi {
    Write-Info "=== wedi Installation Script ==="
    Write-Info ""
    ...
    # The release workflow creates files named: wedi-windows-x86_64.exe, wedi-windows-i686.exe
    ...
    Write-Info ""
    Write-Info "Usage:"
    Write-Info "  $APP_NAME <filename>       - Edit a file"
...
function Uninstall-Wedi {
    Write-Info "=== wedi Uninstallation Script ==="
    Write-Info ""
